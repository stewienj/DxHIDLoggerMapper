...
gcroot<HIDLogger::HIDLoggerInterface^> g_loggerInterface;
...
INT_PTR CALLBACK MainDlgProc(HWND hDlg, UINT msg, WPARAM wParam, LPARAM lParam) {
  ...
  case WM_INITDIALOG:
    ...
    g_loggerInterface = gcnew HIDLogger::HIDLoggerInterface();
    g_loggerInterface->StartLogging(TEXT("C:\\HIDLogs"));
