...
// to compile with
void _cdecl LogError(const TCHAR *, DWORD, const TCHAR *, const TCHAR *){}
void _cdecl LogError(const TCHAR *, const TCHAR *, DWORD, const TCHAR *){}
void _cdecl LogError(const TCHAR *, const TCHAR *, const TCHAR *, const TCHAR *){}
