...
MonitorKeyboard::MonitorKeyboard(GUID deviceGuid, HIDMonitorDLL::HIDMonitorInterface^ loggerInterface) : HIDMonitor(HIDMonitorDLL::DeviceType::Keyboard, deviceGuid, loggerInterface) {
}

void MonitorKeyboard::Log(const DIKBSTATE& kbState) {
  TCHAR keyName[256];
