...
MapperJoystick::MapperJoystick(GUID deviceGuid, HIDMapperDLL::HIDMapperInterface^ loggerInterface) : HIDMapper(HIDMapperDLL::DeviceType::Joystick, deviceGuid, loggerInterface) {
}
